...
|---|---|---|---|
| `genetic_algorithm` | 1.8685e-03 | 1430.5 | 0.0044 |
| `CMA-ES` | 1.4413e+02 | 38.4 | 0.9268 |
| `multi_start (FD)` | 1.1306e-03 | 301.6 | 0.0054 |
| `multi_start (CasADi AD)` | 1.5513e-06 | 184.9 | 0.0003 |
| `multi_start (Myokit FSA)` | 1.5981e-06 | 42.2 | 0.0003 |
...
| method | best cost | time (s) |
|---|---|---|
| `genetic_algorithm` | 2.2420e-02 | 2890.8 |
| `CMA-ES` | 3.2925e-02 | 118.5 |
| `multi_start (Myokit FSA)` | 2.2552e-02 | 6244.9 |
| `multi_start (CasADi bdf)` | 2.2753e-02 | 2309.7 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 9.1704e-04 | 132.1 | 0.3602 |
| `CMA-ES` | 1.0710e-04 | 78.0 | 0.7689 |
| `multi_start (FD)` | 9.1452e-15 | 42.1 | 0.0000 |
| `multi_start (Myokit FSA)` | 1.5193e-13 | 43.8 | 0.0000 |
| `multi_start (CasADi AD)` | 1.3147e-12 | 98.8 | 0.0000 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 6.0216e-04 | 37.7 | 0.0419 |
| `CMA-ES` | 9.8736e-09 | 4.0 | 0.0002 |
| `multi_start (FD)` | 3.2838e-15 | 37.1 | 0.0000 |
| `multi_start (Myokit FSA)` | 3.5621e-15 | 634.3 | 0.0000 |
