...
_No benchmark results published yet. Run `python benchmarks/run_benchmarks.py --set ci --update-docs` locally, or trigger the **Benchmarks** GitHub Actions workflow and **merge the "refresh published benchmark results" PR** it opens, to populate this section._
