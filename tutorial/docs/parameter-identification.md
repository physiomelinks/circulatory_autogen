...
|---|---|---|---|
| `genetic_algorithm` | 5.1610e-03 | 868.9 | 0.0349 |
| `CMA-ES` | 1.4413e+02 | 21.4 | 4.0000 |
| `multi_start (FD)` | 1.5246e-03 | 142.3 | 0.0337 |
| `multi_start (CasADi AD)` | 3.8510e-06 | 118.7 | 0.0029 |
| `multi_start (Myokit FSA)` | 6.5434e-06 | 42.5 | 0.0011 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 1.3841e-03 | 4274.3 | 0.0088 |
| `CMA-ES` | 9.2934e-05 | 77.9 | 0.0183 |
| `multi_start (Myokit FSA)` | 2.0529e-06 | 2226.2 | 0.0012 |
| `multi_start (CasADi bdf)` | 1.4970e-05 | 568.6 | 0.0036 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 2.1056e-03 | 104.4 | 0.0136 |
| `CMA-ES` | 4.6938e-06 | 79.1 | 0.0022 |
| `multi_start (FD)` | 9.1452e-15 | 35.0 | 0.0000 |
| `multi_start (Myokit FSA)` | 1.5193e-13 | 37.4 | 0.0000 |
| `multi_start (CasADi AD)` | 1.3147e-12 | 73.1 | 0.0000 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 4.3302e-04 | 37.5 | 0.0327 |
| `CMA-ES` | 8.0179e-09 | 4.2 | 0.0000 |
| `multi_start (FD)` | 3.2838e-15 | 44.8 | 0.0000 |
| `multi_start (Myokit FSA)` | 3.5621e-15 | 700.8 | 0.0000 |
